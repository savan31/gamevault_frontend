                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="space-y-8 text-dark-300 leading-relaxed">
                        ...
                        <section className="bg-dark-900/50 border border-dark-800 rounded-2xl p-6 md:p-8">
                            ...
                            <p>
                                If you require any more information or have any questions about our privacy policy, please feel free to contact us by email at <a href="mailto:privacy@gamevault.com" className="text-primary-400 hover:underline">privacy@gamevault.com</a> or via our <Link href="/contact-us" className="text-primary-400 hover:underline">contact page</Link>.
                            </p>
                        </section>
                    </div>
                </div>

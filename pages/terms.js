                ...
                <main className="min-h-screen bg-gray-900 py-12">
                    <div className="container mx-auto px-4 max-w-4xl">
                        ...
                        <div className="space-y-6 text-gray-300 leading-relaxed">
                            ...
                            <section className="bg-gray-800 rounded-xl p-6">
                                <h2 className="text-2xl font-semibold text-white mb-4">Revisions and Errata</h2>
                                <p>
                            ...
                            <section className="bg-gray-800 rounded-xl p-6">
                                ...
                                <p>
                                    If you have any questions about these Terms of Service, please contact us at our <Link href="/contact" className="text-purple-400 hover:text-purple-300 underline">contact page</Link>.
                                </p>
                            </section>
                        </div>
                    </div>
